...
public class DtoContrato {
    ...
    public DtoContrato(int id, String cpf, String nm, String cnpj, String tel, String dtInicio, String dtPrazo, String servico, String sistema, String desc, String email, String ende, String espc, double valor) {
        Id = id;
        Cpf = cpf;
        Nm = nm;
        Cnpj = cnpj;
