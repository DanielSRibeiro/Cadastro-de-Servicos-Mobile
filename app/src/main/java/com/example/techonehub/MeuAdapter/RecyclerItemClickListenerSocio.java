...
public class RecyclerItemClickListenerSocio implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerItemClickListenerSocio(Context context, final RecyclerView recyclerView, OnItemClickListener listener) {
        mListener = listener;
