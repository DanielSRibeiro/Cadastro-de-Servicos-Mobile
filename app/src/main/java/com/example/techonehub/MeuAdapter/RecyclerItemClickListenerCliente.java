...
public class RecyclerItemClickListenerCliente implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerItemClickListenerCliente(Context context, final RecyclerView recyclerView, OnItemClickListener listener) {
        mListener = listener;
