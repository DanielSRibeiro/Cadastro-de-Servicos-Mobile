package com.example.techonehub.model;
...
public class DaoTechOneHub extends SQLiteOpenHelper {
    ...
    public DaoTechOneHub(@Nullable Context context) {
        super(context, "TECHONEHUB", null, 2);
    }
    ...
    public long Insert(DtoCliente dtoCliente) {
        ...
        clienteValues(dtoCliente, values);
    ...
    public long InsertServico(DtoServico dtoServico) {
        ContentValues values = new ContentValues();
        ServicoValues(dtoServico, values);
    ...
    public ArrayList<DtoCliente> Select() {
        ...
        clienteCursor(cursor, arrayList);
    ...
    public ArrayList<DtoServico> SelectServico() {
        ...
        servicoCursor(cursor, arrayList);
    ...
    private void clienteValues(DtoCliente dtoCliente, ContentValues values) {
    ...
    private void socioValues(DtoSocio dtoSocio, ContentValues values) {
        values.put("NM", dtoSocio.getNm());
        values.put("CPF", dtoSocio.getCpf());
        values.put("ESPEC", dtoSocio.getEspec());
    }

    private void loginValues(DtoLogin dtoLogin, ContentValues values) {
        values.put("LOGIN", dtoLogin.getLogin());
        values.put("SENHA", dtoLogin.getSenha());
    }

    private void ServicoValues(DtoServico dtoServico, ContentValues values) {
    ...
    private void servicoCursor(Cursor cursor, ArrayList<DtoServico> arrayList) {
    ...
    private void clienteCursor(Cursor cursor, ArrayList<DtoCliente> arrayList) {
        while (cursor.moveToNext()) {
    ...
    private void socioCursor(Cursor cursor, ArrayList<DtoSocio> arrayList) {
        while (cursor.moveToNext()) {
